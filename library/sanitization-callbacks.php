 ...
 */
function herosense_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function herosense_sanitize_css( $css ) {
 ...
 */
function herosense_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function herosense_sanitize_email( $email, $setting ) {
...
function herosense_sanitize_hex_color( $hex_color, $setting ) {
    // Sanitize $input as a hex value without the hash prefix.
 ...
 */
function herosense_sanitize_html( $html ) {
 ...
 */
function herosense_sanitize_image( $image, $setting ) {
    /*
 ...
 */
function herosense_sanitize_nohtml( $nohtml ) {
 ...
 */
function herosense_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function herosense_sanitize_number_range( $number, $setting ) {
 ...
 */
function herosense_sanitize_select( $input, $setting ) {
 ...
 */
function herosense_sanitize_url( $url ) {
